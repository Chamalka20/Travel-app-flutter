...
import '../blocs/restaurantsList_bloc.dart';
  ...
  _asyncMethod() async {
   ...
   Future<void> getplaceDetails () async {
    ...
    if(searchResults[0]['type']=='locality'){
      ...
      restBloc.eventStreamSink.add(searchResults[0]['name']);
      //getAttractionPlaces();
                              ...
                              StreamBuilder<dynamic>(
                                ...
                                builder: (context, AsyncSnapshot<dynamic> snapshot) {
                                  ...
                                  if(snapshot.hasData ){
                                    ...
                                    attracFavBloc.eventStreamSink.add(snapshot.data);
                               ...
                               StreamBuilder<dynamic>(
                                 ...
                                 builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                                  if(snapshot.hasData && snapshot.data!=null && snapshot.data.isNotEmpty){
                                    ...
                                    restFavBloc.eventStreamSink.add(snapshot.data);
                                    return StreamBuilder<dynamic>(
                                                                                          ...
                                                                                          onTap: () async =>{
                                                                                            //favorites =await fechApiData.getFavorites(),
                                                                                              ...
                                                                                              if (snapshot2.data[index] == false) {
                                                                                                ...
                                                                                                await fechApiData.addToFavorite(atPlaceId,restaurantnName,image,type),
